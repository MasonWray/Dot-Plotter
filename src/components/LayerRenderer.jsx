...
function renderVectorLayer(layer, ref, dispatch) {
    if (layer.raster) {
        console.log("Rendering Vector: ", layer.name)
        ...
        dispatch({ type: ACTIONS.SET_VECTOR_DATA, payload: { id: layer.id, vector_data: vector_data } })
...
function renderRasterLayer(layer, ref, dispatch) {
    if (layer.source) {
        console.log("Rendering Raster: ", layer.name)
